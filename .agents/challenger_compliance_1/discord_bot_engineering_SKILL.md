...
description: Comprehensive playbook covering the tech stack, architecture, asynchronous design patterns, and Trust & Safety compliance required to build production-ready Discord bots (based on the DBM project).
---
